...
class multiStreamTrt{
    ...
    private:
        ...
        bool splitNetwork(nvinfer1::INetworkDefinition* network, std::vector<nvinfer1::INetworkDefinition*>& splittedNetworks, nvinfer1::IBuilder* builder, nvinfer1::IBuilderConfig*);
